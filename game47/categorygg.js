...
// Dynamic ad script injector for category page (adx version)
import { ad_code_identifier } from "./ads.js";

console.log("Loading categorygg.js...");
...
function insertAdsToContainers() {
  ...
  if (!selectedAdunit || !selectedAdunit.category) {
    console.warn("⚠️ No category ads found in selected adunit, using home ads as fallback");
    if (selectedAdunit && selectedAdunit.home) {
      console.log("✅ Falling back to home ads");
    } else {
      return;
    }
  }

  let categoryAds = selectedAdunit.category ? [...selectedAdunit.category] : [...selectedAdunit.home]; 
...
console.log("✅ categorygg.js loaded successfully");
