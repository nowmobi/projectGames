...
class CommonUI {
  constructor() {
    this.categoryIconMap = {
      puzzle: `/public/images/puzzle.svg`,
      action: `/public/images/action.svg`,
      racing: `/public/images/racing.svg`,
      adventure: `/public/images/adventure.svg`,
      sports: `/public/images/sports.svg`,
      girl: `/public/images/girl.svg`,
      kids: `/public/images/kids.svg`,
  ...
  createCategoryItem(category, displayName) {
    ...
    const iconSrc = this.categoryIconMap[category] || `/public/images/puzzle.svg`;
    item.innerHTML = `
      <img src="${iconSrc}" alt="${displayName}" class="category-icon">
...
class CategoryPage {
  ...
  createGameCard(game) {
    ...
    card.addEventListener("click", () => {
      ...
      const currentPath = window.location.pathname;
      const isInPagesFolder = currentPath.includes("/pages/");
      const detailPath = isInPagesFolder ? "../detail.html" : "detail.html";
