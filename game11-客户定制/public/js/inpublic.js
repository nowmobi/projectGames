...
export function createGameCardHTML(game, detailPagePath) {
    ...
    return `
        <a class="game-card" href="${finalDetailPath}?id=${game.id}">
...
export function createGameListItemHTML(game, detailPagePath) {
    ...
    return `
        <a class="game-list-item" href="${finalDetailPath}?id=${game.id}">
...
function createCategoryMenuItem(category, categoryName) {
    ...
    categoryItem.href = category === 'home' ? getHomePagePath() : getCategoryPagePath(category);
