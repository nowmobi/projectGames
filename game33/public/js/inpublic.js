...
export function createGameCardHTML(game, detailPagePath) {
    ...
    const cardClass = isCategoryPage ? 'game-card category-page-card' : 'game-card home-page-card';
    const ratingValue = formatGameRating(game.rating);
    const downloadDisplay = formatDownloadsDisplay(game.downloads);
    
    return `
        <div class="${cardClass}" onclick="window.location.href='${finalDetailPath}?id=${game.id}'">
            ...
            <div class="game-card-content-wrapper">
                <div class="game-card-info">
                    ...
                    <div class="game-card-descript-container">
                        <p class="game-card-descript">${game.description || 'No description available'}</p>
                    </div>
                ...
                <div class="game-card-play">
                    <img src="./public/images/play.svg" alt="Play" width="24" height="24">
                </div>
            </div>
        </div>
    `;
...
function createCategoryProductCardHTML(game, detailPagePath) {
    ...
    const downloadDisplay = formatDownloadsDisplay(game.downloads);
    return `
        <div class="game-card category-page-card" onclick="window.location.href='${finalDetailPath}?id=${game.id}'">
            <div class="game-card-image-wrapper">
