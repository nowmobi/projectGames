...
import { createGameCardHTML, getCategoryDisplayName, getCategoryPagePath } from './inpublic.js';
...
function displaySearchResults(games) {
    ...
    renderGamesToContainer(homepageGameGrid, games);
}
...
function generateHomepageGames(loadedGameDetails) {
    ...
    renderGamesToContainer(homepageGameGrid, selectedGames);
}
